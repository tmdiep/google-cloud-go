...
var (
	...
	waitTimeout   = flag.Duration("timeout", 90*time.Second, "timeout for receiving all messages per cycle")
	...
	printInterval = flag.Int("print_interval", 5, "print status every n-th message sent/received")
)
